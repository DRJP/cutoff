...
(fit_1  <- em(yy,"normal","normal", penaltyScale=1E6))
(fit_2  <- em(yy,"normal","weibull", penaltyScale=1E6))
(fit_3  <- em(yy,"normal","gamma", penaltyScale=1E6))
(fit_4  <- em(yy,"normal","log-normal", penaltyScale=1E6))
(fit_5  <- em(yy,"weibull","normal", penaltyScale=1E6))
(fit_6  <- em(yy,"weibull","weibull", penaltyScale=1E6))
(fit_7  <- em(yy,"weibull","gamma", penaltyScale=1E6))
(fit_8  <- em(yy,"weibull","log-normal", penaltyScale=1E9))
(fit_9  <- em(yy,"gamma","normal", penaltyScale=1E6))
(fit_10 <- em(yy,"gamma","weibull", penaltyScale=1E6))
(fit_11 <- em(yy,"gamma","gamma", penaltyScale=1E6))
(fit_12 <- em(yy,"gamma","log-normal", penaltyScale=1E9))
(fit_13 <- em(yy,"log-normal","normal", penaltyScale=1E6))
(fit_14 <- em(yy,"log-normal","weibull", penaltyScale=1E9))
(fit_15 <- em(yy,"log-normal","gamma", penaltyScale=1E9))
(fit_16 <- em(yy,"log-normal","log-normal", penaltyScale=1E6))

par(mfrow=c(4,4))
hist(yy, freq=FALSE, breaks=seq(minyy, maxyy, by=0.5), xlab="MFI", sub=paste("devinace", fit_1$deviance), main="normal-normal");           lines(fit_1, col="blue", lwd=2)
hist(yy, freq=FALSE, breaks=seq(minyy, maxyy, by=0.5), xlab="MFI", sub=paste("devinace", fit_2$deviance), main="normal-weibull");          lines(fit_2, col="blue", lwd=2)
hist(yy, freq=FALSE, breaks=seq(minyy, maxyy, by=0.5), xlab="MFI", sub=paste("devinace", fit_3$deviance), main="normal-gamma");            lines(fit_3, col="blue", lwd=2)
hist(yy, freq=FALSE, breaks=seq(minyy, maxyy, by=0.5), xlab="MFI", sub=paste("devinace", fit_4$deviance), main="normal - log-normal");     lines(fit_4, col="blue", lwd=2)
hist(yy, freq=FALSE, breaks=seq(minyy, maxyy, by=0.5), xlab="MFI", sub=paste("devinace", fit_5$deviance), main="weibull-normal");          lines(fit_5, col="blue", lwd=2)
hist(yy, freq=FALSE, breaks=seq(minyy, maxyy, by=0.5), xlab="MFI", sub=paste("devinace", fit_6$deviance), main="weibull-weibull");         lines(fit_6, col="blue", lwd=2)
hist(yy, freq=FALSE, breaks=seq(minyy, maxyy, by=0.5), xlab="MFI", sub=paste("devinace", fit_7$deviance), main="weibull-gamma");           lines(fit_7, col="blue", lwd=2)
hist(yy, freq=FALSE, breaks=seq(minyy, maxyy, by=0.5), xlab="MFI", sub=paste("devinace", fit_8$deviance), main="weibull - log-normal");    lines(fit_8, col="blue", lwd=2)
hist(yy, freq=FALSE, breaks=seq(minyy, maxyy, by=0.5), xlab="MFI", sub=paste("devinace", fit_9$deviance), main="gamma-normal");            lines(fit_9, col="blue", lwd=2)
hist(yy, freq=FALSE, breaks=seq(minyy, maxyy, by=0.5), xlab="MFI", sub=paste("devinace", fit_10$deviance), main="gamma-weibull");           lines(fit_10, col="blue", lwd=2)
hist(yy, freq=FALSE, breaks=seq(minyy, maxyy, by=0.5), xlab="MFI", sub=paste("devinace", fit_11$deviance), main="gamma-gamma");             lines(fit_11, col="blue", lwd=2)
hist(yy, freq=FALSE, breaks=seq(minyy, maxyy, by=0.5), xlab="MFI", sub=paste("devinace", fit_12$deviance), main="gamma-log-normal");        lines(fit_12, col="blue", lwd=2)
hist(yy, freq=FALSE, breaks=seq(minyy, maxyy, by=0.5), xlab="MFI", sub=paste("devinace", fit_13$deviance), main="log-normal - normal");     lines(fit_13, col="blue", lwd=2)
hist(yy, freq=FALSE, breaks=seq(minyy, maxyy, by=0.5), xlab="MFI", sub=paste("devinace", fit_14$deviance), main="log-normal - weibull");    lines(fit_14, col="blue", lwd=2)
hist(yy, freq=FALSE, breaks=seq(minyy, maxyy, by=0.5), xlab="MFI", sub=paste("devinace", fit_15$deviance), main="log-normal-gamma");        lines(fit_15, col="blue", lwd=2)
hist(yy, freq=FALSE, breaks=seq(minyy, maxyy, by=0.5), xlab="MFI", sub=paste("devinace", fit_16$deviance), main="log-normal - log-normal"); lines(fit_16, col="blue", lwd=2)
